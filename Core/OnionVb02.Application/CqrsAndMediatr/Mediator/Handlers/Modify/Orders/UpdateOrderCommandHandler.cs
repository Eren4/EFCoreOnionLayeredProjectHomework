...
{
    public class UpdateOrderCommandHandler : IRequestHandler<UpdateOrderMediatorCommand>
    {
        ...
        public async Task Handle(UpdateOrderMediatorCommand command, CancellationToken cancellationToken)
        {
