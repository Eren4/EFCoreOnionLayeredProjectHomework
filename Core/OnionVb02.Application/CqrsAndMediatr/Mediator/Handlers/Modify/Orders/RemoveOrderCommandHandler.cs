...
{
    public class RemoveOrderCommandHandler : IRequestHandler<RemoveOrderMediatorCommand>
    {
        ...
        public async Task Handle(RemoveOrderMediatorCommand command, CancellationToken cancellationToken)
        {
