...
{
    public class UpdateProductCommandHandler : IRequestHandler<UpdateProductMediatorCommand>
    {
        ...
        public async Task Handle(UpdateProductMediatorCommand command, CancellationToken cancellationToken)
        {
